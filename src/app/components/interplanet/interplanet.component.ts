...
@Component({
  selector: 'app-interplanet',
  templateUrl: './interplanet.component.html',
  styleUrls: ['./interplanet.component.css']
})
export class InterplanetComponent implements OnInit {
